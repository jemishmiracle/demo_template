...
/// )
/// ```
class CustomFadeImage extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _CustomFadeImageState();
}

class _CustomFadeImageState extends State<CustomFadeImage> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(CustomFadeImage old) {
    // not called on init
    super.didUpdateWidget(old);
    _update(context, old);
  }

  void _update(BuildContext context, [CustomFadeImage? old]) {
