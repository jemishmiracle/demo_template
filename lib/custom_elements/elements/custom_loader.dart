...
class CustomLoader extends StatefulWidget {
  /// [CustomLoader] shows differnt type of loaders with different customization options.
  const CustomLoader(
      {Key? key,
        ...
        this.type = CustomLoaderType.android,
        this.loaderIconOne,
        this.loaderIconTwo,
  ...
  /// Type of [CustomLoaderType] ie, android, ios, circle , square and custom
  final CustomLoaderType type;
  ...
  Widget build(BuildContext context) => Container(
    child: widget.child != null
      ...
      child: widget.child,
        ...
        : widget.type == CustomLoaderType.android
        ? Center(
        child: Container(
        ...
        : widget.type == CustomLoaderType.ios
        ? Center(
...
class Loader extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Center(
    child: type == CustomLoaderType.custom
      ...
      decoration: BoxDecoration(
          color: color,
          shape: type == CustomLoaderType.circle
              ? BoxShape.circle
              : BoxShape.rectangle),
    ),
  );
